...
public class Magician : Job
{
    ...
    {
        jobName = "Magician";
        fireBall = (GameObject)Resources.Load("Character/Ball");
    }
    ...
    public override void doAttack(GameObject weapon)
    {
        ...
        GameObject f = Instantiate(fireBall,transform.position + new Vector3(dir*0.842f, 0.061f, -1f), Quaternion.identity);
        f.GetComponent<FireBall>().setDirection(new Vector3(dir,0,0));
    }
